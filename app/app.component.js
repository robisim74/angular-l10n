System.register(['angular2/core', 'angular2/common', 'angular2/router', './services/locale.service', './services/localization.service', './pipes/localization.pipe', './home.component', './advanced-use.component'], function(exports_1) {
    ...
    var core_1, common_1, router_1, locale_service_1, localization_service_1, localization_pipe_1, home_component_1, advanced_use_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (advanced_use_component_1_1) {
                advanced_use_component_1 = advanced_use_component_1_1;
            }],
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        new router_1.AsyncRoute({ path: '/advanced-use', loader: function () { return Promise.resolve(advanced_use_component_1.AdvancedUseComponent); }, name: 'AdvancedUse' })
                    ]), 
